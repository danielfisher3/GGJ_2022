...
public class GoblinAI : MonoBehaviour
{
    ...
    enum RandomAttack { Attack1, Attack2, Attack3, NoAttack };
    ...
    private void Awake()
    {
        ...
        rAttackSet.Add(RandomAttack.Attack3);
    ...
    public void Die()
    {
        ...
        enemyAnim.SetBool("Attack3", false);
    ...
    public void Attack3()
    {
        ...
        enemyAnim.SetBool("Attack2", false);
        enemyAnim.SetBool("Attack1", false);
        enemyAnim.SetBool("Attack3", true);
