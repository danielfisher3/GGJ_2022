...
public class DeathKingAI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bossSliderText.text = "Daryl the Death King";
        phase2 = false;
    ...
    public void Die()
    {
        ...
        bossAnim.SetBool("Attack7", false);
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "PlayerSword" && !phase2)
        {
        ...
        else if(other.gameObject.tag == "PlayerSword" && phase2)
        {
            if (other.gameObject.name == "DivineSword")
            {
                hasBeenTickled = true;
